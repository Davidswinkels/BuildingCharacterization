...
with open(result_file_name, 'wb') as result_file:
  ...
  wr.writerow(['building_class', 'fov', 'architecture', 'iteration', 'train_n', 'validation_n', 'test_n','kappa','precision','recall','computation_time(seconds)','test_accuracy', 'average_accuracy'])
      ...
      for iteration in iterations:    
        ...
        with open(stats_file_name, 'r') as stats_file:
          ...
          with open(result_file_name, 'ab') as result_file:
            ...
            row = [building_class, fov, architecture, iteration, outcome_stats_data[0], outcome_stats_data[1], outcome_stats_data[2], outcome_stats_data[3], outcome_stats_data[4], outcome_stats_data[5], outcome_stats_data[6], outcome_stats_data[7], outcome_stats_data[8]] 
            wr.writerow(row)
